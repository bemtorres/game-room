...
<div class="row">
  <div class="col-12 col-md-6">
    <div class="row mb-3">
      <div class="col-4 col-md-4">
        <img src="{{ $user_room->getPhoto() }}" class="cursor rounded-circle shadow-lg mg-fluid border border-primary border-3" width="100" height="100" alt="" data-bs-toggle="modal" data-bs-target="#avatarModal">
      </div>
      <div class="col-8 col-md-8">
