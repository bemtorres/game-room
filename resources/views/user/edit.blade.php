    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card flex-fill">
          ...
          {{-- </div> --}}
          <form class="form-submit" action="{{ route('usuarios.update',$u->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="inputNombre" name="name" value="{{ $u->name }}" placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    <label for="inputCorreo" class="col-sm-4 col-form-label">Correo</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="inputNombre" name="email" value="{{ $u->email }}"  placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    <label for="inputCorreo" class="col-sm-4 col-form-label">Telefono</label>
                    <div class="col-sm-8">
                      <input type="tel" class="form-control" id="inputNombre" name="phone" value="{{ $u->phone }}" placeholder="">
                    </div>
                  </div>

                  <div class="btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary">
                      <input type="checkbox" name="admin" {{ $u->admin ? 'checked' : '' }} > Es administrador
                    </label>
                  </div>
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <form class="form-submit" action="{{ route('user.password',$u->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group row mb-3">
                    <label for="inputNombre" class="col-sm-4 col-form-label">Password <small>123456</small></label>
                    <div class="col-sm-8">
                      <input type="password" class="form-control" id="inputNombre" name="password" value="123456" placeholder="" required>
                    </div>
                  </div>
                </div>
              </div>
