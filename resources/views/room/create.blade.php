              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  {{-- <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="inputDescripcion" name="code" placeholder="">
                    </div>
                  </div> --}}
                  <div class="form-group row mb-3">
                    <label for="inputCorreo" class="col-sm-4 col-form-label">Password</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="inputNombre" name="password" placeholder="">
                    </div>
                  </div>
                  <div class="form-group row mb-3">
                    <label for="inputCorreo" class="col-sm-4 col-form-label">Precio</label>
                    <div class="col-sm-8">
                      <input type="number" class="form-control" id="inputNombre" name="price" placeholder="">
                    </div>
                  </div>
                </div>
                {{-- <div class="col-md-6">
